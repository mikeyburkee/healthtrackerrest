    ...
    inner class UpdateUsers {
        ...
        fun `updating existing user in table results in successful update`() {
            transaction {
                ...
                //Act & Assert
                val user3Updated = User(3, updatedName, updatedEmail, updatedWeight, updatedHeight, updatedAge, updatedGender)
        ...
        fun `updating non-existent user in table results in no updates`() {
            transaction {
                ...
                //Act & Assert
                val user4Updated = User(4, updatedName, updatedEmail, updatedWeight, updatedHeight, updatedAge, updatedGender)
